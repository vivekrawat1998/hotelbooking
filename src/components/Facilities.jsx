  ...
  return (
    <div className="relative w-full h-full py-44 bg-white overflow-hidden">
      <div className="grid md:grid-cols-2 grid-cols-1 z-10 relative">
        {/* Left Content */}
        <div className="md:space-y-6 px-10">
          <h1 className="text-sec md:text-xl text-xl">Know Us</h1>
          ...
          <button onClick={handleonclick} className="bg-primary mt-5 px-10 py-3 text-white rounded-md hover:bg-primary/90 transition-all">
            Reserve Your Stay
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-2 grid-cols-2 gap-6 text-white font-bold text-4xl px-10 z-10 mt-10 md:mt-0">
          <div className="p-6 bg-primary text-center rounded-lg">
            ...
            <p className="md:text-3xl  text-xl font-MyCustomFont text-sec mt-2">Happy Guests</p>
          </div>
          <div className="p-6 bg-primary/20 text-primary text-center rounded-lg">
            <CountUp end={250} duration={3} />+
            <p className="md:text-3xl  text-xl font-MyCustomFont text-sec mt-2">Comfortable Rooms</p>
          </div>
          <div className="p-6 bg-primary/20 text-primary text-center rounded-lg">
            <CountUp end={99} duration={3} />%
            <p className="md:text-3xl  text-xl font-MyCustomFont text-sec mt-2">Guest Satisfaction</p>
          </div>
          <div className="p-6 bg-primary text-center rounded-lg">
            <CountUp end={20} duration={3} />+
            <p className="md:text-3xl  text-xl font-MyCustomFont text-sec mt-2">Years of Hospitality</p>
          </div>
        </div>
      </div>
    </div>
